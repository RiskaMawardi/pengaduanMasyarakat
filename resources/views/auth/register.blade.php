                    ...
                    <main class="form-register">
                        <form action="{{route('register')}}" method="POST">
                           @csrf
                            ...
                            <div class="form-floating">
                                <input type="number" name="nik" class="form-control mt-2" id="nik" placeholder="type your nik..">
                            ...
                            <div class="form-floating">
                                <input type="number" name="no_tlp" class="form-control mt-2" id="nik" placeholder="+62">
